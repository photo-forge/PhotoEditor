...
class FrameCategoryView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override init(frame: CGRect) {
        ...
        let categoryImages = frameInfoDic?["Categories"] as? [AnyHashable]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CategoryCell", for: indexPath) as! FrameMenuCategoryCell
...
class FrameMenuCategoryCell: UICollectionViewCell {
