...
public protocol FilterCategoryViewDelegate {
    func filterCategoryView_didSelectAt(filterCategoryName:String)
}

class FilterCategoryView: UIView, UICollectionViewDataSource, UICollectionViewDelegate {
    
    var delegate:FilterCategoryViewDelegate!
    ...
    override init(frame: CGRect) {
        ...
        let categoryImages = filterInfoDic?["Categories"] as? [AnyHashable]
        ...
        collectionView.register(FilterMenuCategoryCell.self, forCellWithReuseIdentifier: "CategoryCell")
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "CategoryCell", for: indexPath) as! FilterMenuCategoryCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if (delegate != nil) {
            delegate.filterCategoryView_didSelectAt(filterCategoryName:categoryNames[indexPath.row])
        }
    }
    
}

class FilterMenuCategoryCell: UICollectionViewCell {
